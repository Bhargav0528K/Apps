...
if($username!="")
{
  $display_message="block";
	...
	if($message=="SUCCESS")
	{
		$message="<strong>SUCCESS!</strong> Details updated in the system!";
...
<div class="container">
 ...
 <!-- <img src="images/Administrator.png" class="col-sm-offset-1  col-sm-5">-->
  ...
  <h3 class="text-center">Edit Account</h3><br>
  <form id="addUserForm" class="form-horizontal" role="form" method="post" action="edit-account.php">
