...
if($username!="")
{
  $display_message="block";
	...
	{
  $message=userExists($username) ;
  if($message>0)
  {
    $message="<strong>User Exists!</strong>";
    $message_type="alert-danger";
  }
  else{
	...
	if($message=="SUCCESS")
	{
		$message="<strong>SUCCESS!</strong> Please Login!";
...
<div class="container">
 ...
 <!-- <img src="images/Administrator.png" class="col-sm-offset-1  col-sm-5">-->
  ...
  <form id="addUserForm" class="form-horizontal" role="form" method="post" action="register.php">
