...
var a="";
var b="";
a=document.studentlogin.user.value;
b=document.studentlogin.password.value;
if(a=="")
{
...
<form name="studentlogin" method="post" onsubmit="return validation()" action="./StudentLoginService">
