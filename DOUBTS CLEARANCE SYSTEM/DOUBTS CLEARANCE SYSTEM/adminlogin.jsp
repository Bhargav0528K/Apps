...
var a="";
var b="";
a=document.adminlogin.user.value;
b=document.adminlogin.password.value;
if(a=="")
{
...
<form name="adminlogin" method="post" onsubmit="return validation()" action="./AdminLoginService">
...
<div style="width:1340px;height:50px;padding:0px;border-radius:5px;border:5px #AF23A5;background-color:green;">
